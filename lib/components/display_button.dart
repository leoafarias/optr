...
class OptrDisplayButton extends StatelessWidget {
  final Widget label;
  final Widget icon;
  final Color color;
  ...
  factory OptrDisplayButton.success({
    Key key,
  ...
  factory OptrDisplayButton.active({
    Key key,
    Widget label,
    Widget icon,
    EdgeInsets padding = const EdgeInsets.all(15.0),
  ...
  factory OptrDisplayButton.cancel({
    Key key,
    Widget label,
    Widget icon,
    EdgeInsets padding = const EdgeInsets.all(15.0),
  ...
  factory OptrDisplayButton.error({
    Key key,
    Widget label,
    Widget icon,
    EdgeInsets padding = const EdgeInsets.all(15.0),
